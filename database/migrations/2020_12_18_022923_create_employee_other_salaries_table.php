...
class CreateEmployeeOtherSalariesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('employee_other_salary_histories', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('employee_other_salaries');
    }
}
